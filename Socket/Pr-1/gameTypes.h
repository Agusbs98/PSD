...
/** Code for performing a move */
#define TURN_MOVE_MSG "Its your turn. You play with:"

/** Code for waiting */
#define TURN_WAIT_MSG "Your rival is thinking... please, wait! You play with:"
...
#define CONNECT_MESSAGE "Connected successful"
...
typedef struct listplayerpoints
{
	tPlayerPoint players[MAX_SCORES];
	int nPlayers;
}tListPlayerPoints;
